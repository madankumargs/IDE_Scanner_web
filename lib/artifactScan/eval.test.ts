...
function scan(dir: string, file: string) { return analyzeArtifact([{ path: file, name: file, content: readFileSync(join(root, dir, file), "utf8") }], { kind: file.includes("SKILL") ? "skill" : file.includes("mcp") ? "mcp" : "npm" }); }
